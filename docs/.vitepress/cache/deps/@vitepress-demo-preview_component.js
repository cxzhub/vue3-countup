...
// node_modules/.pnpm/@vitepress-demo-preview+component@2.3.0_64orlc4jlwufccskewf6i3ruty/node_modules/@vitepress-demo-preview/component/dist/preview-component.js
var Z = (t, c) => {
  const e = t.__vccOpts || t
  for (const [l, r] of c) e[l] = r
  return e
}
var q = {}
var G = {
                  ...
                  createElementBlock(
                    'div',
                    {
                      ...
                      class: normalizeClass([
                        unref(l).bem('message-notice', 'container')
                      ]),
...
var fe = defineComponent({
  ...
  setup(t) {
    const c = t,
      e = F(),
      { isCodeFold: l, setCodeFold: r } = S(),
      { copyContent: p, clickCopy: _ } = U(),
      v = ref(decodeURIComponent(c.code)),
      g = ref(decodeURIComponent(c.showCode)),
      i = ref(null),
      y = () => {
        _(v.value), E.open()
      },
