// node_modules/.pnpm/countup.js@2.6.2/node_modules/countup.js/dist/countUp.min.js
var t = function () {
  return (
    (t =
      Object.assign ||
...
var i = (function () {
  function i2(i3, n, s) {
    ...
    ;(this.endVal = n),
      ...
      (this.el = 'string' == typeof i3 ? document.getElementById(i3) : i3),
      this.el
  ...
  return (
    ...
    (i2.prototype.printValue = function (t2) {
      ...
      if (this.el) {
        ...
        if (
          null === (i3 = this.options.plugin) || void 0 === i3
            ? void 0
            : i3.render
        )
